...
public class Siri20ToSiriWS14Subscription extends SiriSubscriptionRouteBuilder {
    ...
    public Siri20ToSiriWS14Subscription(CamelConfiguration config, SiriHandler handler, Subscription subscription, SubscriptionManager subscriptionManager) {
    ...
    public void configure() throws Exception {
        ...
        from("direct:" + getStartSubscriptionRouteName(subscription))
                ...
                .routeId("start.ws.14.subscription."+subscription.getVendor())
        ;
        ...
        from("direct:" + getCancelSubscriptionRouteName(subscription))
                ...
                .routeId("cancel.ws.14.subscription."+subscription.getVendor())
        ;
